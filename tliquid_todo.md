...
| P1-002 | Implement configurable shortcuts | Phase 1 | FR-032, FR-033, FR-034 | in-progress | claude-opus-4.7 | 2026-05-27T16:15:57Z |  | User can change the primary (translate-selection) and secondary shortcuts, and optional additional-language shortcuts; conflicts are detected; invalid shortcuts are rejected; settings persist. | Include reset-to-default action. The open-panel hotkey was removed post-Phase-0 (panel opens via the tray); see §3a. |
